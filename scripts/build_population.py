...
from src import get_gm_ladder, get_chall_ladder, get_df_data, get_matchids, enrich_with_objectives
...
df_ladder.to_csv(INTERIM_DIR / "ladder_population.csv", index=False) #De momento usamos csv, se planea migrar a una DB


df_ladder = pd.read_csv(INTERIM_DIR / 'ladder_apex_csv.csv')  
